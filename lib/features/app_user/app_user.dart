...
final appUserStreamProvider = StreamProvider.autoDispose.family<AppUser?, String>((ref, userId) {
...
final appUserFutureProvider = FutureProvider.autoDispose.family<AppUser?, String>((ref, userId) {
